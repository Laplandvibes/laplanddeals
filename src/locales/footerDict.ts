...
export function footerDict(lang: Lang) {
  ...
  if (lang === 'ja') {
    return {
      ...
      partner: { title: 'パートナーシップ', body: '27のラップランド関連サイトでの広告や提携。', cta: 'お問い合わせ →' },
  ...
  if (lang === 'ko') {
    return {
      ...
      partner: { title: '파트너십', body: '27개 라플란드 관련 사이트에서 광고와 협업.', cta: '문의하기 →' },
  ...
  if (lang === 'nl') {
    return {
      ...
      about: {
        ...
        body: 'De toonaangevende gids voor Fins Lapland, van het noorderlicht tot de middernachtzon. Geselecteerde ervaringen, insidertips en de praktische basis voor uw Arctische reis.',
  ...
  return {
    ...
    partner: { title: 'Yhteistyö kanssamme', body: 'Mainosta tai tee yhteistyötä 27 Lappi-sivustolla.', cta: 'Ota yhteyttä →' },
