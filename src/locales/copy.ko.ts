  ...
  pulse: {
    ...
    items: [
      ...
      },
      {
        ...
        body: '활발한 윈도우는 대략 8월 말부터 4월 초까지 이어집니다. 사리셀캐, 이나리, 우츠요키의 오로라 관측률이 가장 높습니다. 헌팅 투어는 보통 24시간 전까지 취소할 수 있어 임박 예약도 쉽습니다.',
      },
    ],
  },
  sections: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: '소수의 성수기를 제외하면 대체로 그렇습니다. 오두막, 허스키 자리, 오로라 헌팅에 날짜가 임박해 미판매 공간이 남으면 파트너가 실시간 가격으로 공개하며, 오로라와 허스키 투어는 출발 약 24시간 전까지 예약을 받는 경우가 많습니다. 예외는 크리스마스, 새해, 부활절, 2월 학교 방학으로, 이 시기에는 수요가 높아 기다려도 도움이 되는 일이 드뭅니다.',
      },
      {
