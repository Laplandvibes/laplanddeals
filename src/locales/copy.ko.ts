    ...
    items: [
      {
        ...
        body: '7월 내내 해가 거의 지지 않습니다. 호숫가 통나무집은 겨울 요금보다 훨씬 저렴하고, 2월에 매진됐던 그 툰투리 지역이 지금은 한산합니다. 1년 중 가성비가 가장 좋은 시기입니다.',
      },
      {
        when: '지금부터 8월까지',
        title: '하이킹과 물놀이 시즌',
        body: '팔라스-윌래스툰투리와 동부 툰투리 지대가 건조하고 활짝 열려 있습니다. 긴 낮 동안 하이킹, SUP, 호수 수영을 즐기세요. 모기는 8월에 걸쳐 잦아듭니다. 6월 말에는 헤드넷을 챙기세요.',
      },
      {
        when: '9월 5~15일',
      ...
      },
      {
        ...
        body: '활발한 윈도우는 대략 8월 말부터 4월 초까지 이어집니다. 사리셀카, 이나리, 우츠요키의 오로라 관측률이 가장 높습니다. 헌트 투어는 보통 24시간 전까지 취소할 수 있어 임박 예약도 쉽습니다.',
      },
    ],
  },
  sections: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: '소수의 성수기를 제외하면 대체로 그렇습니다. 오두막, 허스키 자리, 오로라 헌트에 날짜가 임박해 미판매 공간이 남으면 파트너가 실시간 가격으로 공개하며, 오로라와 허스키 투어는 출발 약 24시간 전까지 예약을 받는 경우가 많습니다. 예외는 크리스마스, 새해, 부활절, 2월 학교 방학으로, 이 시기에는 수요가 높아 기다려도 도움이 되는 일이 드뭅니다.',
      },
      {
