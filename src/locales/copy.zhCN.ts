    ...
    items: [
      {
        ...
        body: '整个7月太阳几乎不落。湖边小屋的价格远低于冬季，二月一房难求的那些山地此时十分清静。这是一年里相当实惠的出行时机。',
      },
      {
        when: '现在至8月',
        title: '徒步与亲水季节',
        body: '帕拉斯-于拉斯通图里国家公园和东部山地地势开阔、路径干爽。白昼漫长，适合徒步、桨板和湖中游泳。蚊虫在整个8月逐渐减少；6月底前往请带上防蚊头网。',
      },
      {
        when: '9月5日 – 15日',
        title: 'Ruska（秋色）：很快进入高峰',
      ...
      },
      {
        when: '机票较划算的时机',
        title: '从赫尔辛基出发提前4-8周',
        body: '芬兰航空和挪威航空的赫尔辛基往返拉普兰机票在提前4-8周预订时通常降至89-129欧元区间，圣诞、复活节和2月高峰除外。',
      },
      {
        when: '8月下旬起',
        title: '极光季节再度开启',
        body: '极光观测季大致从8月下旬延续到4月初。萨利色尔卡、伊纳里和乌茨约基的可见极光率较高。极光之旅一般可在出发前24小时内预订，因此临时加入很方便。',
      },
    ],
  },
  sections: {
