...
const ja: SectionCopy = {
  ...
  pulse: {
    ...
    items: [
      ...
      },
      {
        when: '2026年クリスマス',
        title: 'すでに予約が動いています',
        body: 'グラスイグルーやサンタクロース村のファミリールームは、8月下旬には予約終了となるのが通例です。クリスマスイブのディナーやトナカイそり枠は、10月までにほぼ満枠となります。',
      },
      {
        when: '航空券のお得な時期',
      ...
      },
      {
        ...
        body: '観測好機はおおむね8月下旬から4月初旬まで続きます。サーリセルカ、イナリ、ウツヨキは可視率が最も高いエリアです。オーロラハントは通常24時間前まで予約可能なため、直前の追加も簡単です。',
      },
    ],
  },
  sections: {
  ...
  tiles: [
    { label: 'ホテル & コテージ', hint: 'グラスイグルー · ゲレンデサイド · 山小屋ロッジ' },
  ...
  hotelsPage: {
    ...
    seoTitle: 'ラップランドのホテルお得情報、グラスイグルー、ゲレンデサイド、山小屋',
    seoDesc:
      'フィンランド・ラップランド各地のグラスイグルー、スキーイン宿、ファミリーホテル、ウィルダネスロッジのリアルタイム価格。直前予約とシーズン終盤のコテージもあります。',
