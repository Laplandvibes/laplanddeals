...
const ja: SectionCopy = {
  ...
  hotelsPage: {
    ...
    h1: '今夜のリアルタイム価格。',
    sub:
      'オーロラベルト下のガラスイグルー、レヴィのゲレンデサイドのお宿、ユッラスのウィルダネスロッジ、ロヴァニエミのファミリーホテル。今夜のレートをリアルタイムで比較できます。',
    seoTitle: 'ラップランドのホテルお得情報、ガラスイグルー、ゲレンデサイド、山小屋',
    seoDesc:
      'フィンランド・ラップランド各地のガラスイグルー、スキーイン宿、ファミリーホテル、ウィルダネスロッジのリアルタイム価格。直前予約とシーズン終盤のコテージもあります。',
