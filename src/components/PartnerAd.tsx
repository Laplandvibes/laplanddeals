...
const ADVERTISERS: Record<AdvertiserId, AdvertiserConfig> = {
  ...
  lodging: {
    ...
    tagline: {
      ...
      ja: 'ラップランドの宿をひとつに。グラスイグルーからゲレンデ脇まで、本日の最新料金で。',
      ...
      'zh-CN': '拉普兰所有住宿一站搞定，从玻璃冰屋到雪道旁，按今日实时价。',
    ...
    points: {
      ...
      ja: ['ホテル・コテージ・グラスイグルー', '料金と空室はリアルタイム', 'ラップランド全域をひとつの検索で'],
      ...
      'zh-CN': ['酒店、小屋与玻璃冰屋', '实时价格与空房', '一次搜索覆盖全拉普兰'],
      ko: ['호텔, 캐빈, 글래스 이글루', '실시간 요금과 예약 가능 여부', '한 번의 검색으로 라플란드 전역'],
