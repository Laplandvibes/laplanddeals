...
const rawOffers = (lang: TripLang): RawOffer[] => {
  ...
  // ── Hotels ──────────────────────────────────────────────────────────
  {
    ...
    blurb: {
      ...
      fi: 'Koko alueella on noin 30 lasi-iglua. Jouluviikot varataan loppuun jo elokuussa, avaa Hotels.com nähdäksesi mitä tälle illalle on jäljellä.',
      de: 'In der gesamten Region gibt es rund 30 Glas-Iglus. Die Weihnachtswochen sind bis August ausgebucht, öffnen Sie Hotels.com und sehen Sie, was heute Abend noch frei ist.',
      ja: '地域全体でガラスイグルーはおよそ30棟しかありません。クリスマスの週は8月までに満室に, Hotels.comを開いて今夜の空き状況をご確認ください。',
      es: 'En toda la región existen unos 30 iglús de cristal. Las semanas de Navidad se agotan en agosto, abre Hotels.com para ver qué queda esta noche.',
      'pt-BR': 'Em toda a região existem cerca de 30 iglus de vidro. As semanas de Natal esgotam até agosto, abra a Hotels.com para ver o que resta hoje à noite.',
      'zh-CN': '整个地区大约只有30间玻璃穹顶屋。圣诞档期到八月就被订满——打开 Hotels.com 看看今晚还剩什么。',
      ko: '지역 전체에 글라스 이글루는 약 30채뿐입니다. 크리스마스 주간은 8월이면 매진됩니다, Hotels.com을 열어 오늘 밤 남은 객실을 확인하세요.',
  ...
  },
  {
    ...
    location: {
      en: 'Ruka · Oulanka NP',
      fi: 'Ruka · Oulangan kansallispuisto',
      de: 'Ruka · Nationalpark Oulanka',
      ja: 'ルカ · オウランカ国立公園',
      es: 'Ruka · P. N. Oulanka',
      'pt-BR': 'Ruka · P. N. Oulanka',
      'zh-CN': 'Ruka · Oulanka 国家公园',
      ko: 'Ruka · Oulanka 국립공원',
      fr: 'Ruka · P. N. Oulanka',
      it: 'Ruka · P. N. Oulanka',
      nl: 'Ruka · NP Oulanka',
    },
