...
const rawOffers = (lang: TripLang): RawOffer[] => {
  ...
  },
  {
    ...
    blurb: {
      ...
      'pt-BR': 'Ski-in / ski-out na maior colina da Finlândia (43 pistas, 230 km de trilhas). As semanas de fim de temporada (15 mar – 12 abr) costumam estar disponíveis a tarifas mais baixas.',
      'zh-CN': '在芬兰最大的山丘上享受 ski-in / ski-out(43 条雪道,230 公里雪径)。季末几周(3 月 15 日 – 4 月 12 日)通常仍有空房,价格更低。',
      ko: '핀란드 최대 펠에서 즐기는 ski-in / ski-out(슬로프 43개, 트랙 230km). 시즌 막바지 주간(3월 15일 – 4월 12일)은 보통 더 낮은 요금으로 아직 예약 가능합니다.',
  ...
  },
  {
    ...
    blurb: {
      ...
      de: 'Der wilde Osten, Bärenland, der Karhunkierros-Pfad, Husky-Farmen, der zuverlässigste Schnee Finnlands (oft bis in den Mai).',
  ...
  },
  {
    ...
    blurb: {
      ...
      es: 'Temporada de auroras del 15 sep al 5 abr. Cacerías guiadas por fotógrafos, hogueras en lagos helados, cabañas móviles. Cancelación normalmente 24 h antes.',
      'pt-BR': 'Temporada de auroras de 15 set a 5 abr. Caçadas guiadas por fotógrafos, fogueiras em lagos congelados, cabanas móveis. Cancelamento normalmente 24 h antes.',
      'zh-CN': '极光季为 9 月 15 日 – 4 月 5 日。摄影师带队追光、冰湖篝火、移动小屋。通常提前 24 小时可取消。',
      ko: '오로라 시즌은 9월 15일 – 4월 5일. 사진작가 인솔 헌트, 얼어붙은 호수의 모닥불, 이동식 캐빈. 취소는 보통 24시간 전까지.',
  ...
  },
  {
    ...
    blurb: {
      ...
      'pt-BR': 'Cerca de 200 cooperativas de pastoreio de renas na Finlândia. Passeios de trenó tranquilos, kotas aquecidas a fogo, famílias sámi. Reserve os horários de manhã cedo, a luz mais serena.',
      'zh-CN': '芬兰约有 200 个驯鹿牧业合作社。悠缓的雪橇游、炉火温暖的科塔帐篷、萨米家庭。建议预订清晨时段——光线最为宁静。',
      ko: '핀란드에는 약 200개의 순록 방목 협동조합이 있습니다. 느긋한 썰매, 불로 데운 코타, 사미 가족. 이른 아침 시간대를 예약하면 가장 고요한 빛을 만납니다.',
  ...
  },
  {
    ...
    blurb: {
      ...
      de: 'Der Inarisee friert bis Januar 60–80 cm tief zu. Bohren, ablassen, warten. Ausrüstung + Heißgetränke + ein Guide, der weiß, wo die Barsche ziehen.',
  ...
  },
  {
    ...
    blurb: {
      ...
      de: 'Schnellster Weg nach Levi (15 Min.) und Ylläs (50 Min.). Finnair fliegt im Winter 2–4-mal täglich; die Strecke ruht von Mai bis August fast vollständig.',
  ...
  // ── Summer (kesä-sääntö) ───────────────────────────────────────────
  {
    ...
    blurb: {
      ...
      'pt-BR': '32 dias em que o sol nunca se põe (6 jun – 7 jul acima de 70°N). As diárias em cabanas à beira do lago ficam 30-50% abaixo das tarifas de dezembro. Os mosquitos atingem o pico no fim de junho.',
      'zh-CN': '太阳整整 32 天不落(北纬 70° 以北,6 月 6 日 – 7 月 7 日)。湖畔小屋夜间价格比 12 月低 30-50%。蚊虫在六月下旬最盛。',
      ko: '해가 지지 않는 32일(북위 70도 이북, 6월 6일 – 7월 7일). 호숫가 캐빈 1박은 12월 요금보다 30~50% 저렴합니다. 모기는 6월 말에 절정.',
